...
FLOWER_KEYWORD_STEMS: dict[str, list[str]] = {
    ...
    "герберы": ["гербер"],
    "альстромерии": ["альстромер"],
    "лилии": ["лили", "лилия"],
    "гвоздики": ["гвоздик"],
    "эустома": ["эустом"],
    "анемоны": ["анемон"],
    "лютики": ["лютик", "ранункул", "ранункулюс"],
    "фрезии": ["фрез"],
    "ирисы": ["ирис"],
    "нарциссы": ["нарцисс"],
    "подсолнухи": ["подсолнух"],
    "орхидеи": ["орхиде", "орхид"],
    "гортензии": ["гортенз"],
    "пионы": ["пион"],
    "астры": ["астр"],
    "гипсофила": ["гипсофил"],
...
BOUQUET_KEYWORD_STEMS: dict[str, list[str]] = {
    "цветы": ["цвет"],
    "монобукет": ["монобукет", "моно"],
    "композиция": ["композици"],
    "авторский букет": ["авторск", "автор"],
    "декор": ["декор"],
    "букет в коробке": ["коробк", "box"],
    "цветочная корзина": ["корзин"],
    "свадебный букет": ["свадеб"],
    "каскадный букет": ["каскад"],
}
