...
from app.api.v1.routers.client.site_asset import router as site_asset_router
...
api_v1_routers.include_router(site_asset_router, prefix="/site-assets", tags=["site-assets"])
