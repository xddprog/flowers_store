        ...
        <div className="flex flex-col lg:flex-row gap-6 md:gap-8 lg:gap-12 items-start justify-between">
          <div className="flex flex-col gap-4 md:gap-6 w-full lg:w-auto">
            ...
            <section className="flex flex-col gap-1 md:gap-1.5">
              <div className="flex items-start gap-2">
                ...
                />
                <p className="text-white font-sans text-[16px] md:text-[18px] lg:text-[20px] leading-relaxed">
          ...
          <div className="flex flex-col gap-3 md:gap-4 w-full lg:w-auto">
            ...
            <nav className="flex flex-col gap-1.5 md:gap-2">
              <Link
                to="#"
                className="text-white font-sans text-[16px] md:text-[18px] lg:text-[20px] hover:opacity-80 transition-opacity"
              >
                Каталог
              </Link>
              <Link
            ...
            <div className="flex flex-col gap-2 md:gap-3">
              ...
              <div className="flex items-center gap-2">
                <a
                  ...
                  className="text-white font-sans text-[16px] md:text-[18px] lg:text-[20px] hover:opacity-80 transition-opacity break-all"
                >
